...
# =============================================================================
# mIoU-only (for BO / programmatic use)
# =============================================================================
...
def get_miou(
    ...
    """
    Load final.csv from tunnel dir and return mIoU. No plots, no report.
    Returns 0.0 if no ground truth in final.csv.
    """
