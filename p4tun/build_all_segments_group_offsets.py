...
Usage:
  python p4tun/build_all_segments_group_offsets.py 4-1 --data-dir data [--k-file detected_k_dbscan.csv]
"""
...
_agents_detection = os.path.join(PROJECT_ROOT, "agents", "irregular", "2_detection", "2_detection.py")
...
def main():
    ...
    params_path = os.path.join(
        PROJECT_ROOT, "agents", "irregular", "2_detection", "parameters", args.tunnel_id,
