...
# ORIGINAL VERSION WITHOUT MAX_INDICES CAP
...
if len(sys.argv) != 2:
    print("Usage: python 3_enhancing_original.py <tunnel_id>")
    print("Example: python 3_enhancing_original.py 1-4")
    sys.exit(1)
...
def enhance_outlier_points(df, depth_threshold_low=0.003, depth_threshold_high=0.008,
    ...
    # NO CAP - process all outlier points (original notebook behavior)
    print(f"Generating interpolated points for {len(filtered_indices)} outlier points (no cap)...")
