...
# specify the tunnel_id according to input
tunnel_id = "5-1"
...
# -----main function-----
def enhance_segment_surface(df, target_distance=0.10, curvature_threshold=0.0003, num_neighbors=20):
...
upsampling_params = [
    {'target_distance': 0.10},  # First upsampling
    {'target_distance': 0.05},  # Second upsampling
    {'target_distance': 0.025}   # Third upsampling
]
...
# Cell 10
# use new thresholds, radius, and full 13 rings for full coverage
meaningful_df, new_df = enhance_outlier_points(
    df_support_filtered_curva,
    depth_threshold_low=0.005,
    depth_threshold_high=0.010,
    inter_radius=0.08,
