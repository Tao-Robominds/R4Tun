#!/usr/bin/env python
"""
Memory+State ablation orchestrator (OpenAI GPT-5.4).
...
Usage:
    ./venv/bin/python run_memory_state_gpt.py 1-1
    ./venv/bin/python run_memory_state_gpt.py 1-1 3-1-1 4-1
    ./venv/bin/python run_memory_state_gpt.py --all
    ./venv/bin/python run_memory_state_gpt.py 1-1 --dry-run   # prompts only, no API

**Routine runs** omit ``--model``: default tag ``gpt5.4`` and parameter files ``*_m_s_gpt5.4.json``.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Memory+State ablation orchestrator (OpenAI GPT-5.4)",
    )
    parser.add_argument(
        "tunnel_ids", nargs="*",
