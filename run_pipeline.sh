...
python3 configurable/configurable_unfolding.py "$TUNNEL_ID"
check_status "Unfolding"

# Step 2: Denoising
echo ""
echo "Step 2/7: Running denoising..."
python3 configurable/configurable_denoising.py "$TUNNEL_ID"
check_status "Denoising"

# Step 3: Enhancing
echo ""
echo "Step 3/7: Running enhancing..."
python3 configurable/configurable_enhancing.py "$TUNNEL_ID"
check_status "Enhancing"

# Step 4: Detecting
echo ""
echo "Step 4/7: Running detecting..."
python3 configurable/configurable_detecting.py "$TUNNEL_ID"
...
python3 configurable/configurable_sam.py "$TUNNEL_ID"
check_status "SAM segmentation"

# Step 7: Evaluation
echo ""
echo "Step 7/7: Running evaluation..."
python3 configurable/evaluation.py "$TUNNEL_ID"
