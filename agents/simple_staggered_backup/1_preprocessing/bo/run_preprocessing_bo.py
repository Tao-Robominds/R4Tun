...
gradient_threshold, curvature_neighbors, depth_map_resolution) to maximize
Retention F2 score.
...
DEFAULT_TARGET_DISTANCES = preprocessing_module.DEFAULT_TARGET_DISTANCES
DEFAULT_INTERPOLATION_WINDOW = preprocessing_module.DEFAULT_INTERPOLATION_WINDOW
...
def get_preprocessing_dimensions() -> Tuple[List, List[str]]:
    """
    Define search space for preprocessing parameters (6 total).
    ...
    dimensions = [
        ...
        Integer(10, 30, name='curvature_neighbors'),      # Curvature computation neighbors
        Real(0.003, 0.008, name='depth_map_resolution'),  # Depth map resolution
    ]
    ...
    def __call__(self, params: List) -> float:
        ...
        try:
            ...
            params_to_save = {
                ...
                'interpolation_window': get_param(existing_params, 'interpolation_window', default=DEFAULT_INTERPOLATION_WINDOW, allow_default=True),
            }
    ...
    def _log_trial(
        ...
        log_data = {
            ...
            'params': {
                ...
                'curvature_neighbors': int(params['curvature_neighbors']),
                'depth_map_resolution': float(params['depth_map_resolution']),
            },
        }
...
def load_best_from_logs(logs_dir: str, tunnel_id: str) -> Optional[Tuple[List[float], float]]:
    ...
    param_values = [
        ...
        int(best_params['curvature_neighbors']),
        best_params['depth_map_resolution'],
    ]
