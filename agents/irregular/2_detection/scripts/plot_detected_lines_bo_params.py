...
Usage (from repo root):
  ./venv/bin/python agents/irregular/2_detection/scripts/plot_detected_lines_bo_params.py 5-1 --data-dir data
"""
import os
import sys
import json
...
# Repo root (2_detection -> irregular -> agents -> repo)
SCRIPT_DIR = Path(__file__).resolve().parent
IRREGULAR_2 = SCRIPT_DIR.parent  # 2_detection
REPO_ROOT = IRREGULAR_2.parent.parent.parent  # irregular, agents, repo
