...
def load_parameters(tunnel_id: str = None, base_dir: str = "data") -> Tuple[Dict, bool]:
    ...
    Priority:
        1. agents/continuous/2_detection/parameters/<tunnel_id>/parameters_detection.json
        2. data/<tunnel_id>/parameters_detection.json
        3. agents/continuous/2_detection/parameters/sample/parameters_detection.json
