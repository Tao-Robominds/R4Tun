...
class SegmentingAnalyser:
    ...
    def load_analysis_data(self, model_tag: str = "glm"):
        ...
        code_path = Path("sam4tun/agents/sam.py")
    ...
    def build_llm_prompt_markdown(self, state_context: str = "", model_tag: str = "glm") -> str:
        ...
        parts += [
            f"# REFERENCE SAM PARAMETERS\n{t3_sam_k_uniform_note(self.tunnel_id, ctx['archive_filename'])}{ctx['parameters_source']}\n\n```json\n{ctx['parameters']}\n```",
