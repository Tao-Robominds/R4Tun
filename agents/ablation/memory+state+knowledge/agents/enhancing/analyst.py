...
class EnhancingAnalyser:
    ...
    def load_analysis_data(self, model_tag: str = "glm"):
        ...
        code_path = Path("sam4tun/agents/enhancing.py")
    ...
    def build_llm_prompt_markdown(self, state_context: str = "", model_tag: str = "glm") -> str:
        ...
        parts += [
            f"# REFERENCE ENHANCING PARAMETERS\n{t3_enhancing_coverage_note(self.tunnel_id, ctx['archive_filename'])}{ctx['parameters_source']}\n\n```json\n{ctx['parameters']}\n```",
