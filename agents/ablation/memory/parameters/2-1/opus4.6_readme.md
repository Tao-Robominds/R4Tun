# Memory-only ablation — tunnel `2-1` — Opus 4.6 (regular-staggered)
...
| Property | Sample | 2-1 | Ratio (tunnel / sample) |
|---|---|---|---|
| total_points | 1109768 | 2062272 | 1.86× |
| length_x_axis (m) | 12.16 | 34.97 | 2.88× |
| width_y_axis (m) | 5.60 | 5.66 | 1.01× |
| height_z_axis (m) | 5.08 | 5.83 | 1.15× |
| estimated_diameter (m) | 5.604292068996665 | 5.658760908509626 | 1.01× |
| median NN (m) | 0.006514481254712708 | 0.005458995959341128 | 0.84× |
| max NN (m) | 0.2442797068280462 | 0.8747166529509901 | 3.58× |
...
See [`process.md`](../../process.md). Regenerate prompts: `./venv/bin/python skills/scripts/export_llm_parameter_context.py 2-1` (repo root). After inference, sync executables:

```bash
./venv/bin/python skills/scripts/sync_inference_to_executable.py --tunnel-id 2-1
```
