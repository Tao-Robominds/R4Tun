...
Usage:
  python -m agents.2_detection.scripts.compare_detect_lines_to_gt [--ring 2] [--tunnel 4-1] [--base-dir data]
...
# Run from project root: python -m agents.2_detection.scripts.compare_detect_lines_to_gt
import importlib
_det = importlib.import_module("agents.2_detection.2_detection")
