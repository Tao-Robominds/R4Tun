...
class UnfoldingAnalyser:
    ...
    def load_analysis_data(self):
        ...
        role_path = Path("agents/unfolding/role.md")
        role_content = self._read_required_text(role_path, "Role definition")
        
        # Load instructions
        instructions_path = Path("agents/unfolding/cot.md")
        ...
        sample_characteristics_path = Path("data/ablation/sample/characteristics/raw_characteristics.json")
        ...
        new_characteristics_path = Path(f"data/ablation/{self.tunnel_id}/characteristics/raw_characteristics.json")
        ...
        code_content = self._read_required_text(code_path, "Sample unfolding code")
        
        # Load current unfolding parameters
        unfolding_params_path = Path("configurable/sample/parameters_unfolding.json")
        unfolding_parameters = self._read_required_json(unfolding_params_path, "Sample unfolding parameters")
