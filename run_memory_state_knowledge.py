#!/usr/bin/env python
"""
Memory+State+Knowledge ablation orchestrator.
...
Usage:
    ./venv/bin/python run_memory_state_knowledge.py 1-1
    ./venv/bin/python run_memory_state_knowledge.py 1-1 3-1-1 4-1
    ./venv/bin/python run_memory_state_knowledge.py --all
    ./venv/bin/python run_memory_state_knowledge.py 1-1 --dry-run   # prompts only, no API
"""
...
# Suffix for parameter filenames, e.g. parameters_unfolding_m_s_k_opus4.6.json
...
def main():
    parser = argparse.ArgumentParser(
        description="Memory+State+Knowledge ablation orchestrator",
    )
    parser.add_argument(
        "tunnel_ids", nargs="*",
