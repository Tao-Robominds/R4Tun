# R4Tun Combined Grouped Review

Sources combined:
- `r4tun_final_manuscript_sentence_review.md` (Source A)
- `r4tun_review_v4_pre_submission_review.md` (Source B)

This combined file preserves all original content from both source files and groups similar issues together via the map below.

## Grouped Issue Map (A = Source A, B = Source B)

### Numerical consistency and reporting alignment
- Abstract/OA phrasing: A1, B9
- Relative percentage mismatch across sections: A2, B1-B3
- Stage count and API-call count mismatch: A3, B6
- Reference diameter / baseline definition drift: B5
- Parameter count and defaults consistency: B7-B8
- Terminology/capitalisation/format consistency: A27, B10-B13
- Citation-model mismatch in Table 3 context: A5, B50

### Claim strength and overstatement control
- Broad adaptability claims: A6, B21
- LLM reasoning/self-verification claims: A9, B16-B17, B20
- Cross-model interpretation and causality wording: A10-A11, B14-B15, B24
- Practical-implication/promotional phrasing: A13, B22
- Discussion causality/convergence wording: A15, A18, B23

### AI-like wording and style refinement
- Vague/promotional abstract phrasing: A14, A29, B27, B32
- Informal or absolute wording in methodology/discussion: A16-A17, B18-B19, B25-B33

### Repetition reduction and structural clarity
- Repeated key terms/phrases: A28-A29, B34-B40
- Section-structure and numbering coherence: A5 (related), A31, B53-B55

### Grammar, typo, and formatting corrections
- Typos and grammar: A20-A24, B41-B49
- Units, symbols, and rendering checks: A26-A27, B46-B47, B51-B52
