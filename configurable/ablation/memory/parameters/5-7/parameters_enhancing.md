# Memory-ablation LLM context — tunnel `5-7`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 5-7
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=5-7)
```json
{
  "tunnel_id": "5-7",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/5-7.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 2169226,
      "data_structure": {
        "columns": 4,
        "description": "x, y, z, intensity"
      },
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 16.29540205048392,
        "width_y_axis": 7.734264955188129,
        "height_z_axis": 7.654296990000001,
        "units": "meters"
      },
      "estimated_diameter": 7.734264955188129,
      "diameter_estimation": {
        "inner_diameter": 7.734264955188129,
        "outer_diameter": 7.734264955188129,
        "average_diameter": 7.734264955188129,
        "median_diameter": 7.734264955188129,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.006661037992809263,
      "median_nearest_neighbor_distance": 0.00523561446003247,
      "min_nearest_neighbor_distance": 0.0004878000000001492,
      "max_nearest_neighbor_distance": 0.29431653753038056,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/5-7/parameters_enhancing.json`).
