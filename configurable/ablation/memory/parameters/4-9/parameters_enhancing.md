# Memory-ablation LLM context — tunnel `4-9`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 4-9
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=4-9)
```json
{
  "tunnel_id": "4-9",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/4-9.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 1937452,
      "data_structure": {
        "columns": 4,
        "description": "x, y, z, intensity"
      },
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 18.106843107624233,
        "width_y_axis": 7.762067341487935,
        "height_z_axis": 7.6635741,
        "units": "meters"
      },
      "estimated_diameter": 7.762067341487935,
      "diameter_estimation": {
        "inner_diameter": 7.762067341487935,
        "outer_diameter": 7.762067341487935,
        "average_diameter": 7.762067341487935,
        "median_diameter": 7.762067341487935,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.007897841047666236,
      "median_nearest_neighbor_distance": 0.006385110220387981,
      "min_nearest_neighbor_distance": 0.0004878000000001492,
      "max_nearest_neighbor_distance": 0.24118059782825585,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/4-9/parameters_enhancing.json`).
