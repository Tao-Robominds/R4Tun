# Memory-ablation LLM context — tunnel `4-10`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 4-10
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=4-10)
```json
{
  "tunnel_id": "4-10",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/4-10.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 1947132,
      "data_structure": {
        "columns": 4,
        "description": "x, y, z, intensity"
      },
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 18.1034420506276,
        "width_y_axis": 7.758766382881593,
        "height_z_axis": 7.69580114,
        "units": "meters"
      },
      "estimated_diameter": 7.758766382881593,
      "diameter_estimation": {
        "inner_diameter": 7.758766382881593,
        "outer_diameter": 7.758766382881593,
        "average_diameter": 7.758766382881593,
        "median_diameter": 7.758766382881593,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.007980693863698587,
      "median_nearest_neighbor_distance": 0.006496460875053495,
      "min_nearest_neighbor_distance": 0.0004878000000001492,
      "max_nearest_neighbor_distance": 0.24584017449477202,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/4-10/parameters_detecting.json`).
