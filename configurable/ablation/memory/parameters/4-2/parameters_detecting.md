# Memory-ablation LLM context — tunnel `4-2`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 4-2
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=4-2)
```json
{
  "tunnel_id": "4-2",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/4-2.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 1944075,
      "data_structure": {
        "columns": 4,
        "description": "x, y, z, intensity"
      },
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 18.0675768799795,
        "width_y_axis": 7.7366639007492415,
        "height_z_axis": 7.73925817,
        "units": "meters"
      },
      "estimated_diameter": 7.7366639007492415,
      "diameter_estimation": {
        "inner_diameter": 7.7366639007492415,
        "outer_diameter": 7.7366639007492415,
        "average_diameter": 7.7366639007492415,
        "median_diameter": 7.7366639007492415,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.007939451448189676,
      "median_nearest_neighbor_distance": 0.006422373155236218,
      "min_nearest_neighbor_distance": 0.0004878000000001492,
      "max_nearest_neighbor_distance": 0.29923223759934053,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/4-2/parameters_detecting.json`).
