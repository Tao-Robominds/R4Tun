# Memory-ablation LLM context — tunnel `4-8`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 4-8
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=4-8)
```json
{
  "tunnel_id": "4-8",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/4-8.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 1952457,
      "data_structure": {
        "columns": 4,
        "description": "x, y, z, intensity"
      },
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 18.12053104008205,
        "width_y_axis": 7.757289968847851,
        "height_z_axis": 7.62646484,
        "units": "meters"
      },
      "estimated_diameter": 7.757289968847851,
      "diameter_estimation": {
        "inner_diameter": 7.757289968847851,
        "outer_diameter": 7.757289968847851,
        "average_diameter": 7.757289968847851,
        "median_diameter": 7.757289968847851,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.00786257884500684,
      "median_nearest_neighbor_distance": 0.006385722717766662,
      "min_nearest_neighbor_distance": 0.0004878000000001492,
      "max_nearest_neighbor_distance": 0.2438756697867942,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/4-8/parameters_detecting.json`).
