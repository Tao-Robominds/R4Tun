# Memory-ablation LLM context — tunnel `4-6`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 4-6
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=4-6)
```json
{
  "tunnel_id": "4-6",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/4-6.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 1860428,
      "data_structure": {
        "columns": 4,
        "description": "x, y, z, intensity"
      },
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 18.076455460481533,
        "width_y_axis": 7.732016615222262,
        "height_z_axis": 7.61132907,
        "units": "meters"
      },
      "estimated_diameter": 7.732016615222262,
      "diameter_estimation": {
        "inner_diameter": 7.732016615222262,
        "outer_diameter": 7.732016615222262,
        "average_diameter": 7.732016615222262,
        "median_diameter": 7.732016615222262,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.0077807756549841435,
      "median_nearest_neighbor_distance": 0.006233330803414756,
      "min_nearest_neighbor_distance": 0.0004878000000001492,
      "max_nearest_neighbor_distance": 0.5788532438042906,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/4-6/parameters_unfolding.json`).
