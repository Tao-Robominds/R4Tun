# Memory-ablation LLM context — tunnel `3-1-2`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 3-1-2
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=3-1-2)
```json
{
  "tunnel_id": "3-1-2",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/3-1-2.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 252497,
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 12.08915529437917,
        "width_y_axis": 6.0045868951941745,
        "height_z_axis": 6.43840194,
        "units": "meters"
      },
      "estimated_diameter": 6.0045868951941745,
      "diameter_estimation": {
        "inner_diameter": 6.0045868951941745,
        "outer_diameter": 6.0045868951941745,
        "average_diameter": 6.0045868951941745,
        "median_diameter": 6.0045868951941745,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.016583082190252934,
      "median_nearest_neighbor_distance": 0.0148753293499479,
      "min_nearest_neighbor_distance": 0.005000531908505404,
      "max_nearest_neighbor_distance": 0.33635239221577345,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/3-1-2/parameters_unfolding.json`).
