# Memory-ablation LLM context — tunnel `3-1-3`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 3-1-3
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=3-1-3)
```json
{
  "tunnel_id": "3-1-3",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/3-1-3.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 288735,
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 12.052578943847097,
        "width_y_axis": 5.999810175302874,
        "height_z_axis": 5.61738587,
        "units": "meters"
      },
      "estimated_diameter": 5.999810175302874,
      "diameter_estimation": {
        "inner_diameter": 5.999810175302874,
        "outer_diameter": 5.999810175302874,
        "average_diameter": 5.999810175302874,
        "median_diameter": 5.999810175302874,
        "ring_thickness": null,
        "ring_thickness_note": "Not estimated from minimum bounding rectangle; use unfolded/denoised characterisers for r-based ring thickness.",
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.01599213714557241,
      "median_nearest_neighbor_distance": 0.014518969379796706,
      "min_nearest_neighbor_distance": 0.0050002809911586935,
      "max_nearest_neighbor_distance": 0.6618018977180555,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/3-1-3/parameters_denoising.json`).
