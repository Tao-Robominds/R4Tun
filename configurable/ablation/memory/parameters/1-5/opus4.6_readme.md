# Memory-only ablation — tunnel `1-5` — Opus 4.6 (regular-staggered)
...
| Property | Sample | 1-5 | Ratio (tunnel / sample) |
|---|---|---|---|
| total_points | 1109768 | 2324522 | 2.09× |
| length_x_axis (m) | 12.16 | 27.89 | 2.29× |
| width_y_axis (m) | 5.60 | 5.88 | 1.05× |
| height_z_axis (m) | 5.08 | 6.03 | 1.19× |
| estimated_diameter (m) | 5.604292068996665 | 5.884560146218845 | 1.05× |
| median NN (m) | 0.006514481254712708 | 0.005097796705283719 | 0.78× |
| max NN (m) | 0.2442797068280462 | 0.7734280172142941 | 3.17× |
...
See [`process.md`](../../process.md). Regenerate prompts: `./venv/bin/python skills/scripts/export_llm_parameter_context.py 1-5` (repo root). After inference, sync executables:

```bash
./venv/bin/python skills/scripts/sync_inference_to_executable.py --tunnel-id 1-5
```
