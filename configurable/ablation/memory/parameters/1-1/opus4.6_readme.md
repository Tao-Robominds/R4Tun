# Memory-only ablation — tunnel `1-1` — Opus 4.6 (regular-staggered)
...
| Property | Sample | 1-1 | Ratio (tunnel / sample) |
|---|---|---|---|
| total_points | 1109768 | 2037812 | 1.84× |
| length_x_axis (m) | 12.16 | 25.37 | 2.09× |
| width_y_axis (m) | 5.60 | 5.67 | 1.01× |
| height_z_axis (m) | 5.08 | 5.57 | 1.10× |
| estimated_diameter (m) | 5.604292068996665 | 5.66595749971581 | 1.01× |
| median NN (m) | 0.006514481254712708 | 0.005393138346324871 | 0.83× |
| max NN (m) | 0.2442797068280462 | 0.5892839305827955 | 2.41× |
...
See [`process.md`](../../process.md). Regenerate prompts: `./venv/bin/python skills/scripts/export_llm_parameter_context.py 1-1` (repo root). After inference, sync executables:

```bash
./venv/bin/python skills/scripts/sync_inference_to_executable.py --tunnel-id 1-1
```
