# Memory-ablation LLM context — tunnel `2-5`
...
```bash
./venv/bin/python skills/scripts/export_llm_parameter_context.py 2-5
```
...
# TARGET TUNNEL — RAW CHARACTERISTICS (tunnel_id=2-5)
```json
{
  "tunnel_id": "2-5",
  "input_file": "/home/boringtao/Projects/R4Tun/data/subsets/2-5.txt",
  "filtered_note": "Contains only characteristics for x, y, z, intensity columns. Ground truth data (segment_type, ring_number) excluded.",
  "point_cloud_analysis": {
    "basic_statistics": {
      "total_points": 2044861,
      "data_structure": {
        "columns": 4,
        "description": "x, y, z, intensity"
      },
    ...
    "tunnel_geometry": {
      "dimensions": {
        "length_x_axis": 26.617481641722502,
        "width_y_axis": 5.677383232518801,
        "height_z_axis": 6.20947194,
        "units": "meters"
      },
      "estimated_diameter": 5.677383232518801,
      "diameter_estimation": {
        "inner_diameter": 5.677383232518801,
        "outer_diameter": 5.677383232518801,
        "average_diameter": 5.677383232518801,
        "median_diameter": 5.677383232518801,
        "ring_thickness": 0.0,
        "description": "Estimated tunnel diameter based on minimum bounding rectangle width (2D XOY projection). May include surrounding infrastructure.",
        "method": "minimum_bounding_rectangle",
        "note": "This is a 2D projection-based estimate. For more accurate diameter estimation, use cylindrical coordinate analysis (r values) from unfolded point cloud."
    ...
    "point_density": {
      "mean_nearest_neighbor_distance": 0.0073295094732337375,
      "median_nearest_neighbor_distance": 0.005393328513951088,
      "min_nearest_neighbor_distance": 0.00048779999999970514,
      "max_nearest_neighbor_distance": 1.2458185990414423,
      "units": "meters"
    }
  }
}
...
Archived tunnel parameters (same file you will save as `configurable/ablation/memory/parameters/2-5/parameters_unfolding.json`).
