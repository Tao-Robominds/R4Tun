# Memory-only ablation — tunnel `2-5` — Opus 4.6 (regular-staggered)
...
| Property | Sample | 2-5 | Ratio (tunnel / sample) |
|---|---|---|---|
| total_points | 1109768 | 2044861 | 1.84× |
| length_x_axis (m) | 12.16 | 26.62 | 2.19× |
| width_y_axis (m) | 5.60 | 5.68 | 1.01× |
| height_z_axis (m) | 5.08 | 6.21 | 1.22× |
| estimated_diameter (m) | 5.604292068996665 | 5.677383232518801 | 1.01× |
| median NN (m) | 0.006514481254712708 | 0.005393328513951088 | 0.83× |
| max NN (m) | 0.2442797068280462 | 1.2458185990414423 | 5.10× |
...
See [`process.md`](../../process.md). Regenerate prompts: `./venv/bin/python skills/scripts/export_llm_parameter_context.py 2-5` (repo root). After inference, sync executables:

```bash
./venv/bin/python skills/scripts/sync_inference_to_executable.py --tunnel-id 2-5
```
