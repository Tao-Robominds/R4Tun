...
def get_preprocessing_dimensions(tunnel_id: str, agent_type: str = 'continuous') -> Tuple[List, List[str]]:
    """
    ...
    Args:
        ...
        agent_type: Agent type ('continuous', 'continuous', 'complex_staggered')
